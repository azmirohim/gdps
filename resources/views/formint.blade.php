		...
		<div class="container-contact100">
			<div class="wrap-contact100">
				...
				<form class="contact100-form validate-form" id="e-recruit" method="POST" action="{{ route('submitint') }}" enctype="multipart/form-data">
					...
					<div class="wrap-input100 validate-input">
						<input id="jenis" class="input100" type="text" name="jenis" value="INTERNSHIP" style="color: #BDBDBD" readonly>
						<span class="focus-input100"></span>
						<label class="label-input100" for="name">
					...
					<div class="wrap-input100 validate-input"> 
						<select name="job" id="name" class="input100" style="height: 30px; color: #BDBDBD" value="{{ old('job') }}" required>
							<option value="" disabled selected hidden>INTERNSHIP</option>
							@foreach ($intern as $int)
								@if(date_create() < date_create($int->tanggal))
								<option value="{{$int->judul}}">{{$int->judul}}</option>
								@endif
							@endforeach					
						</select>
						<label class="label-input100" for="name">
					...
					<div class="wrap-input100 validate-input"> 
						<select name="pendidikan" id="name" class="input100" style="height: 30px; color: #BDBDBD" value="{{ old('pendidikan') }}" required>
					...
					<div class="wrap-input100 validate-input">
						<input id="email" class="input100" type="email" name="email" placeholder="Email@mail.com" value="{{session()->get('email')}}" required>
						<span class="focus-input100"></span>
					...
					<div class="wrap-input100">
						...
						<input id="others" class="input100" type="file" name="others" value="{{ old('others') }}" required>
						<span class="focus-input100"></span>
						<label class="label-input100 rs1" for="message">
							<span class="lnr lnr-file-add"></span>
						</label>
					...
					<div class="container-contact100-form-btn">
						<button class="contact100-form-btn" type="submitint" id="e-recruit">
							Send Now
						</button>
					</div>
				</form>
