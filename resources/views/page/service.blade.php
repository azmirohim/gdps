@include('includes.header')
    ...
    <section class="breadcrumb-area bg-img jarallax" style="height:350px; background-color:#021c3c;">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-sm-12 col-md-12 heading-section text-center ftco-animate">
                    ...
                    <p class="mt-5" style="color:white;">Untuk meraih visi dan misi perusahaan, kami memiliki nilai-nilai yang menjadi budaya dan harus dianut oleh semua anggota dalam organisasi. Nilai-nilai ini diharapkan bisa membuat organisasi terus bertahan terhadap berbagai perubahan serta tantangan bisnis dari luar.</p>
                </div>
            </div>
